...
public abstract class Repository<T> : IRepository<T> where T : PersistentObject
{
    ...
    private string _connectionString = "Server=localhost;Port=5432;Database=MetrixDb;UserId=postgres;Password=89187786606Alex";
    ...
    public void Create(T item)
    {
        ...
        using (var connection = new NpgsqlConnection(_connectionString)) // Establish a connection to the database.
        {
            ...
            {
                string columnName = property.GetCustomAttribute<ColumnAttribute>().Name; // Get the column name from ColumnAttribute.
